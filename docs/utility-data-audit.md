...
| LADWP and other public utilities | Program and interconnection pages exist, but no common current public project-site feed was verified. | Mark affected cities partial and rely on the CEC county benchmark for all-utility context. |
