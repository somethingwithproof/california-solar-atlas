...
CITY_SCHEMA = schema(
    strings=[
        ...
        "load_sourceUrl", "name", "pouCapacity_basis", "pouCapacity_method", "pouCapacity_reason",
        "pouCapacity_sourceUrl", "pouCapacity_utility", "storageCapacityStatus", "timelineQuality",
        "utilities", "yieldRange",
    ],
    integers=[
        "climateZone", "housingUnits", "housingYear", "load_year", "population", "populationYear",
        "pouCapacity_year", "projects", "sectors_agricultural_projects", "sectors_commercial_projects", "sectors_other_projects",
    ...
    floats=[
        ...
        "load_lowDeliveriesGwh", "pouCapacity_capacityRangeMwDc_high", "pouCapacity_capacityRangeMwDc_low",
        "pouCapacity_cityCoveredPct", "pouCapacity_reportedMw", "pouCapacity_territoryInCityPct",
        "residentialSiteHousingPct", "sectors_agricultural_mw", "sectors_commercial_mw",
        "sectors_other_mw", "sectors_public_mw", "sectors_residential_mw",
        "totalCapacityRangeMwDc_high", "totalCapacityRangeMwDc_low",
        "totalEffectiveCapacityRangeMw_high", "totalEffectiveCapacityRangeMw_low",
        "totalGenerationRangeGwh_high", "totalGenerationRangeGwh_low", "undatedCapacityMw",
    ],
